...
class IgboStewCateg extends StatefulWidget {
  const IgboStewCateg({super.key, required this.priColor, required this.title});
  final Color priColor;
  final String title;

  @override
  State<IgboStewCateg> createState() => _IgboStewCategState();
}

class _IgboStewCategState extends State<IgboStewCateg>
  ...
  void initState() {
    ...
    filteredSoupList = List.from(igboStewList);
  ...
  void _filterSoupList() {
    ...
    setState(() {
      if (query.isEmpty) {
        ...
        filteredSoupList = igboStewList.where((soup) {
