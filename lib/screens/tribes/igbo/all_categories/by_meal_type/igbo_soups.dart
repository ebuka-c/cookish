...
class IgboSoupCateg extends StatefulWidget {
  const IgboSoupCateg({super.key, required this.priColor, required this.title});
  final Color priColor;
  final String title;

  @override
  State<IgboSoupCateg> createState() => _SoupCategState();
}

class _SoupCategState extends State<IgboSoupCateg>
