...
class AllIgboDishes extends StatefulWidget {
  const AllIgboDishes({super.key});

  @override
  State<AllIgboDishes> createState() => _AllIgboDishesState();
}

class _AllIgboDishesState extends State<AllIgboDishes>
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                    opacity: 0.7,
                                    image: AssetImage(
                                        igboDishes[index]['dishImage']),
                                    fit: BoxFit.cover)),
                          ),
                          SizedBox(width: 50.0.w),
                          Text("${igboDishes[index]['dish']}")
                        ],
                      ),
                    ),
                  );
