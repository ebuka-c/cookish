...
class AllYorubaDishes extends StatefulWidget {
  const AllYorubaDishes({super.key});

  @override
  State<AllYorubaDishes> createState() => _AllYorubaDishesState();
}

class _AllYorubaDishesState extends State<AllYorubaDishes>
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                    opacity: 0.7,
                                    image: AssetImage(
                                        yorubaDishes[index]['dishImage']),
                                    fit: BoxFit.cover)),
                          ),
                          SizedBox(width: 50.0.w),
                          Text(yorubaDishes[index]['dish'])
                        ],
                      ),
                    ),
                  );
