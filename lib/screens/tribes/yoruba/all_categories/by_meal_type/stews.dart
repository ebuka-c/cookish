...
class YorubaStewCateg extends StatefulWidget {
  const YorubaStewCateg(
      {super.key, required this.priColor, required this.title});
  final Color priColor;
  final String title;

  @override
  State<YorubaStewCateg> createState() => _yorubaStewCategState();
}

class _yorubaStewCategState extends State<YorubaStewCateg>
  ...
  void initState() {
    ...
    filteredSoupList = List.from(yorubaStewList);
  ...
  void _filterSoupList() {
    ...
    setState(() {
      if (query.isEmpty) {
        ...
        filteredSoupList = yorubaStewList.where((soup) {
