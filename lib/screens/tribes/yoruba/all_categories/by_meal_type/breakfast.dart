...
class YorubaBreakfastCateg extends StatefulWidget {
  const YorubaBreakfastCateg(
      {super.key, required this.priColor, required this.title});
  final Color priColor;
  final String title;

  @override
  State<YorubaBreakfastCateg> createState() => _SoupCategState();
}

class _SoupCategState extends State<YorubaBreakfastCateg>
  ...
  void initState() {
    ...
    filteredSoupList = List.from(yorubaBreakfastList);
  ...
  void _filterSoupList() {
    ...
    setState(() {
      if (query.isEmpty) {
        ...
        filteredSoupList = yorubaBreakfastList.where((soup) {
