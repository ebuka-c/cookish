...
class StewCateg extends StatefulWidget {
  const StewCateg({super.key, required this.priColor, required this.title});
  final Color priColor;
  final String title;

  @override
  State<StewCateg> createState() => _StewCategState();
}

class _StewCategState extends State<StewCateg>
  ...
  void initState() {
    ...
    filteredSoupList = List.from(hausaStewList);
  ...
  void _filterSoupList() {
    ...
    setState(() {
      if (query.isEmpty) {
        ...
        filteredSoupList = hausaStewList.where((soup) {
